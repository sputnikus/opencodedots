...
description: AI-powered code review using CodeRabbit CLI. Finds bugs, security issues, and quality risks in changed code. Trigger for any explicit review request AND autonomously when review is needed (code/PR/quality/security).
license: MIT
metadata:
